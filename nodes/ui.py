...
# Colors.
bgra_dict = {'black'         : (0,0,0,0),
             'white'         : (255,255,255,0),
             'dark_gray'     : (64,64,64,0),
             'gray'          : (128,128,128,0),
             'light_gray'    : (192,192,192,0),
             'red'           : (0,0,255,0),
             'green'         : (0,255,0,0), 
             'blue'          : (255,0,0,0),
             'cyan'          : (255,255,0,0),
             ...
             'yellow'        : (0,255,255,0),
             'dark_red'      : (0,0,128,0),
             'dark_green'    : (0,128,0,0), 
             'dark_blue'     : (128,0,0,0),
             'dark_cyan'     : (128,128,0,0),
             'dark_magenta'  : (128,0,128,0),
             'dark_yellow'   : (0,128,128,0),
             'light_red'     : (175,175,255,0),
             'light_green'   : (175,255,175,0), 
             'light_blue'    : (255,175,175,0),
             'light_cyan'    : (255,255,175,0),
             'light_magenta' : (255,175,255,0),
             'light_yellow'  : (175,255,255,0),
             }
...
class Button(object):
    ...
    def draw(self, image):
        ...
        # Draw the fill.
        cv2.rectangle(image, self.ptLT3, self.ptRB3, self.colorFill, -1)#cv2.cv2_FILLED)
...
class Handle(object):
    ...
    # 
    def draw(self, image):
        cv2.circle(image, tuple(self.pt.astype(int)),  self.radiusDraw, self.color, -1)# cv2.cv2_FILLED)
